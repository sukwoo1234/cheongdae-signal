    ...
    <main className="max-w-2xl mx-auto px-6 py-10 text-sm leading-relaxed text-gray-700">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>운영자가 중대한 악용으로 6개월 차단한 경우 학교 이메일 주소, 차단 사유·일시</li>
      ...
      <section className="mb-6">
        ...
        <p className="mt-2">
          중대한 악용으로 6개월 차단된 경우에는 재가입 방지를 위해 학교 이메일 주소와 차단 사유·일시를
          행사 데이터와 분리하여 차단 시작일부터 6개월간 보관합니다. 행사 데이터 폐기 시에도 만료 전까지
          유지되며, 만료되거나 운영자가 차단을 해제하면 목록에서 삭제합니다. 해당 행사에서 이미 적용된
          행사 차단은 행사 데이터 폐기 시점까지 유지됩니다. 차단 여부나 정보 삭제에 관한 문의는 아래
          9항의 연락처로 요청할 수 있습니다.
        </p>
      </section>
