  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-10 text-sm leading-relaxed text-gray-700">
      ...
      <section className="mb-6">
        ...
        <p>
          "청대 시그널"은 청주대학교 학생 간 새로운 인연을 찾을 수 있도록 카드를 제공하는 한정 기간 운영 서비스입니다.
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>학교 이메일 하나당 운영자가 행사 시작 전에 정한 기본 선택 기회(1회 또는 2회) 규칙 준수</li>
          <li>선택형 보드 행사에서는 남학생·여학생 보드를 자유롭게 전환할 수 있으며 선택 기회는 두 보드에서 합산 차감됨</li>
        </ul>
      </section>
