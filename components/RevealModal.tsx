  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-[#071b33]/55 px-4 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-sm rounded-t-[28px] bg-white p-6 text-center shadow-2xl sm:rounded-[28px] sm:p-8">
        ...
        <div className="mb-1 text-[10px] font-bold uppercase tracking-[0.12em] text-[#8390a2]">{kind === "phone" ? "Phone" : "Instagram / KakaoTalk"}</div>
        ...
        <p className="mb-5 text-[11px] text-[#637083]">{kind === "phone" ? "전화나 문자로 조심스럽게 대화를 시작해보세요." : "등록한 ID로 조심스럽게 대화를 시작해보세요."}</p>
